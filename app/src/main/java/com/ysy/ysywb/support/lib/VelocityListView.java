...
public class VelocityListView extends AutoScrollListView {
     ...
     * @author Cyril Mottier
     */
    private static class ForwardingOnScrollListener implements AbsListView.OnScrollListener {

        private AbsListView.OnScrollListener selfListener;

        private List<AbsListView.OnScrollListener> clientListener = new ArrayList<AbsListView.OnScrollListener>();
        ...
        public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount,
            ...
            for (AbsListView.OnScrollListener l : clientListener) {
